...
async def main():
    if len(sys.argv) < 3:
        print("Usage: python step1_pff_to_zarr.py <pff_path> <zarr_root> [config.toml] [scheduler_address]")
        print()
        print("Arguments:")
        print("  pff_path          - Input PFF file")
        print("  zarr_root         - Output Zarr directory")
